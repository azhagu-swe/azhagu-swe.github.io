...
export function StatsCard({ title, value, icon, trend, trendUp, description, delay = 0 }: StatsCardProps) {
    return (
        <motion.div
            ...
            <MatrixWrapper className="h-full rounded-2xl border border-border/50 bg-card/30 p-6 backdrop-blur-md transition-all hover:bg-card/50 hover:shadow-lg hover:shadow-primary/10">
